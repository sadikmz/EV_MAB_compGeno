### 1. Preparing genomic reads (stLRF/NGS) 
...
# Genome size estimation using FindGSE. Kmer histogram files generated using jellyfish above can be used as input to FindGSE R package.
