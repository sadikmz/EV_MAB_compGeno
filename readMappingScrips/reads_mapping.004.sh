...
do 
	...
	$APPSDIR/bwa-mem2-2.2.1_x64-linux/bwa-mem2 mem -t $cpus $ref "$Fread".rep "$Rread".rep | samtools view - -Sb -@$cpus | samtools view -b -@$cpus -F 4 | samtools sort - -@$cpus -o ${output_dir}/$out.allMapped.sorted.bam
