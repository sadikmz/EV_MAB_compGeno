...
#zcat SRR956987_2*gz SRR957627_2*.gz | bgzip -@$cpus > SRX339427_2.fastq.gz
#zcat SRR956987_1*gz SRR957627_1*.gz | bgzip -@$cpus > SRX339427_1.fastq.gz

for READS in SRX339427 
