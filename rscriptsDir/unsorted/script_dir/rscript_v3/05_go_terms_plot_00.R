...
MA_specific_plot <-
  ...
  mutate(
    ...
    description = str_replace(description, "transmembrane transport", "Transmembrane transport"),
    description = str_replace(description, "intracellular protein transport", "Intracellular protein transport"),
    description = str_replace(description, "abscisic acid-activated signaling pathway", "Abscisic acid-activated signaling pathway"),
    description = str_replace(description, "lipid metabolic process", "Lipid metabolic process"),
    description = str_replace(description, "tricarboxylic acid cycle", "Tricarboxylic acid cycle"),
    description = str_replace(description, "amine metabolic process", "Amine metabolic process"),
    description = str_replace(description, "glycolytic process", "Glycolytic process"),
    description = str_replace(description, "protein glycosylation", "Protein glycosylation"),
    description = str_replace(description, "carbohydrate metabolic process", "Carbohydrate metabolic process"),
    description = str_replace(description, "vernalization response", "Vernalization response")) %>%
  ggplot(aes(x = reorder(description, Count),y = Count)) +
  geom_col(width = 0.8,
           fill = "red",
           alpha = 0.25) +
