...
#Set Heatmap data.
Effectors %>%
  select(1:9) -> selected_heatmap #n = 73 as we do not want to include the race data in the last column. 
...
```{r fig2, fig.height = 15, fig.width = 5 }
...
```
```{r fig3, fig.height = 10, fig.width = 6}
...
data.frame(row.names = colnames(Heatmap_data),
           Race = c("TR4",	"R1",	"R4",	"R4",	"R1",	"TR4",	"Not identified",	"TR4")) -> col_annotations
