...
library(tidyverse)
# load("C:/Users/Sadik/Downloads/bedadeti_EG_MABS_alignment_coverage_dedup.RData")
...
load("EV_EG_MABS_mapping_coverage_R_objects/mazia_MA_alignment_coverage_dedup.RData")
load("EV_EG_MABS_mapping_coverage_R_objects/bedadeti_MA_alignment_coverage_dedup.RData")
