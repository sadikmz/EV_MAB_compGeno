...
bedtools bamtobed -i ${output_path}/${ref_genome}.sorted.allMapped.markdup.q30.bam  | \
bedtools coverage -a "$ref_genome"_100k_windows.bed -iobuf 50000M -b - > ${output_path}/${ref_genome}.allMapped.100k.q30.cov.bed
