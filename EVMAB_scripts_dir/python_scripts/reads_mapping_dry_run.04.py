...
class ToolChecker:
    def __init__(self, tool_paths):
        """Initialize with dictionary of tool paths."""
        self.tool_paths = tool_paths
        self.tools = ['bwa-mem2', 'samtools', 'bedtools', 'qualimap', 'picard', 'bamCoverage']
        self.report = []
    ...
    def check_tools_dry_run(self):
        ...
        for tool in self.tools:
            ...
            if tool == 'picard':
                ...
                picard_path = self.tool_paths.get('picard', shutil.which('picard'))
                if picard_path:
...
def main():
    ...
    # 1. Tool checking
    checker = ToolChecker(tool_paths)
