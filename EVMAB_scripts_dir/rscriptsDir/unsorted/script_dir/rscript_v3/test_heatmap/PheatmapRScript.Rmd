---
title: "Plotting Fola Effector Profile Heatmap"
output: html_notebook
---
```{r}
knitr::opts_chunk$set(fig.width = 70, fig.height = 200)
```
...
read.csv("AllCandidateEffectorSets_65Perc.clstr_heatmapdata.csv") -> AllData 
