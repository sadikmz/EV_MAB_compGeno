...
read.delim("Z:sadik/evmab_dir/EV_MAB.nogo_noreads.ncbi_nr.diamond.blastp.e05.out.gz") %>% 
  ...
  mutate(
    ...
    stitle_bp_annot = case_when(
      ...
      str_detect(stitle_bp_annot, "\\waumatin")  |
        str_detect(stitle_bp_annot, "THAUMATIN") ~ "Thaumatin family profile",
      str_detect(stitle_bp_annot, "\\wisease resistance") ~ "Disease resistance proteins (RPP8-like/RGAs)",
      ...
      str_detect(stitle_bp_annot, "Jacalin-type lectin") ~  "Jacalin-related lectin",
      str_detect(stitle_bp_annot, "Chaperone protein DnaJ") ~  "Chaperone protein DnaJ",

      str_detect(stitle_bp_annot, "\\wrotein of unknown function") |
      ...
      str_detect(stitle_bp_annot, "\\wucleoredoxin") ~  "Nucleoredoxin",
      ...
      str_detect(stitle_bp_annot, "Reverse transcriptase") |
        ...
        str_detect(stitle_bp_annot, "RNA-DIRECTED DNA POLYMERASE HOMOLOG")  |
        str_detect(stitle_bp_annot, "Retrovirus-related") |
        str_detect(stitle_bp_annot, "\\wransposon") |
      ...
      str_detect(stitle_bp_annot, "\\wlutamine-rich protein") ~  "Glutamine-rich protein 2-like",
      ...
      # str_detect(stitle_bp_annot, "Universal stress proteins") ~  "Universal stress protein family",
      str_detect(stitle_bp_annot, "\\wentapeptide") ~  "Pentapeptide repeat-containing proteins",
...
### uniprot 
  ...
  EV_MAB_nogo_noreads_uniprot_nr <-
    read.delim("D:/persdoc_dir/allProject_sciptDir/local_scripts/ev_mab_comparative_genomics/data_dir//EV_MAB.nogo_noreads.uniprot_sprot.diamond.blastp.e05.out.gz") %>% 
    # EV_specific_blasp_ncbi_uniprot_25_perc_CDS_max_interpro %>%
    # mutate(stitle_sp = str_replace_na(stitle_sp, "NA")) %>%
    distinct() %>%
    mutate(
