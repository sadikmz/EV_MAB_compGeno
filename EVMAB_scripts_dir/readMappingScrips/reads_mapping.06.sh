...
for READS in SRR8989633 SRR9734079 SRR9850640
...
do 
	...
	# download reads
	esearch -db sra -query PRJNA540118 | efetch -format runinfo | cut -d ',' -f 1 | grep -E $READS | xargs -n 1 -P $cpus fastq-dump --split-files --gzip --skip-technical
