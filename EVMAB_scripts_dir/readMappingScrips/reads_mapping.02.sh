...
for READS in SRR956987 SRR957627
...
do 
	...
	# download reads
	esearch -db sra -query PRJNA216985 | efetch -format runinfo | cut -d ',' -f 1 | grep -E $READS | xargs -n 1 -P $cpus fastq-dump --split-files --gzip --skip-technical
